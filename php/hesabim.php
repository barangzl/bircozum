				...
				<div class="bg-white shadow rounded-lg d-block d-sm-flex">
					<div class="profile-tab-nav border-right" style="width:20%;">
						...
						<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							...
							<a class="nav-link" id="account-tab" data-toggle="pill" href="#entries" role="tab" aria-controls="account" aria-selected="true">
							<i class="fa fa-exclamation-triangle text-center mr-1"></i>
								Entries
							</a>
							<a class="nav-link" id="account-tab" data-toggle="pill" href="#advices" role="tab" aria-controls="account" aria-selected="true">
					...
					<div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
						...
						<form action="./change_password.php" method="POST">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label id="response">Response HERE!</label>
									</div>
								</div>
							</div>
							<div class="row">
